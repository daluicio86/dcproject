  ...
  return (
    <>
      <div id="version" className="md:scroll-m-[180px] scroll-m-28">
        ...
        <div className="mt-5">
          <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">Cm - Properties Tailwind NextJs Template is built with Tailwindcss and Nextjs.</p>
